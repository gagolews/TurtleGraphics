...
file <- paste("figures/figure_1", ".pdf", sep="")  
...
<<results=hide, echo=FALSE>>=
file <- paste("figures/figure_2", ".pdf", sep="")  
pdf(file=file, onefile=FALSE)  
turtle_init()
turtle_forward(dist=20) 
...
<<results=hide, echo=FALSE>>=
file <- paste("figures/figure_3", ".pdf", sep="")  
pdf(file=file, onefile=FALSE)  
turtle_init()
turtle_forward(dist=20) 
turtle_backward(dist=10)
...
<<results=hide, echo=FALSE>>=
file <- paste("figures/figure_4", ".pdf", sep="")  
pdf(file=file, onefile=FALSE)  
turtle_init()
turtle_forward(dist=20) 
turtle_backward(dist=10)
...
<<results=hide, echo=FALSE>>=
file <- paste("figures/figure_5", ".pdf", sep="")  
pdf(file=file, onefile=FALSE)  
turtle_init()
turtle_forward(dist=20) 
turtle_backward(dist=10)
...
<<results=hide, echo=FALSE>>=
file <- paste("figures/figure_6", ".pdf", sep="")  
pdf(file=file, onefile=FALSE)  
turtle_init()
turtle_forward(dist=20) 
turtle_backward(dist=10)
