...
```{r fig.width=10,fig.align='center',   fig.keep='last' , cache=TRUE, echo=FALSE }
...
```{r fig.width=7,fig.align='center', warning=FALSE, message=FALSE, fig.keep='last' , cache=TRUE}
...
```{r fig.width=10,fig.align='center',   fig.keep='last' , cache=TRUE, echo=2 }
turtle_init()
...
```{r fig.width=10,fig.align='center',   fig.keep='last' , cache=TRUE, echo=3 }
turtle_init()
turtle_forward(dist=15)
...
```{r fig.width=10,fig.align='center',   fig.keep='last' , cache=TRUE, echo=4:7 }
turtle_init()
turtle_forward(dist=15)
turtle_right(angle=30)
turtle_up()
...
```{r fig.width=10,fig.align='center',   fig.keep='last'  , cache=TRUE, echo=8}
turtle_init()
turtle_forward(dist=15)
turtle_right(angle=30)
turtle_up()
...
```{r fig.width=10,fig.align='center',   fig.keep='last', cache=TRUE , cache=TRUE }
...
```
```{r fig.width=10,fig.align='center',   fig.keep='last' , cache=TRUE }
  drawTriangle<- function(points){
  turtle_setpos(points[1,1],points[1,2])
  turtle_goto(points[2,1],points[2,2])
  turtle_goto(points[3,1],points[3,2])
