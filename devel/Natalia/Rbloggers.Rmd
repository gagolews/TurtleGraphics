...
```{r fig.width=10,echo=FALSE, warning=FALSE, message=FALSE, fig.keep='last' }
library(TurtleGraphics)
turtle_init()
```
```{r fig.width=10,fig.align='center', echo=FALSE, fig.keep='last' }
turtle_init()
turtle_do({
...
```
```{r fig.width=10,fig.align='center', echo=FALSE, fig.keep='last', cache=TRUE }
